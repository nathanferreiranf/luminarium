...
export default function Auditorio() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Auditório 28/10</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1062" preserveAspectRatio="none">
                        <Link href="/auditorio/dias/28-10/egina-de-oliveira">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/adilson-rocha">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/lucilia-ribeiro">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/desiree-oliveira">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/deva-vasant">
                            <a>
                        ...
                        {/* Second column */}
                        <Link href="/auditorio/dias/28-10/dr-bruce-lipton">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/penny-peirce">
                            <a>
                        ...
                        {/*<Link href="/auditorio/dias/28-10/rex-thomas">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/clarice-niskier">
                            <a>
                        ...
                        <Link href="/auditorio/dias/28-10/juliana-vilarinho">
                            <a>
                    ...
                    <img src="/images/auditorios/28-10/auditorio.jpg" className="img-background" />
                </div>
            }
        </>
    )
