...
export default function ManifestoVideo() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Video - Manifesto</title>
            </Head>
            {
                authenticated && <div id="page-only-video">
                    <div className="video shadow-sm">
                        <iframe src="https://player.vimeo.com/video/482084538" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
