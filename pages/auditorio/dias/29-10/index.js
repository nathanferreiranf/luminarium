...
export default function Auditorio() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Auditório 29/10</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1062" preserveAspectRatio="none">
                        <Link href="/auditorio/dias/29-10/marbrisa-oliveira">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/tony-paixao">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/alexandre-cumino">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/leticia-tui">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/luciano-alves">
                            <a>
                        ...
                        {/* Second column */}
                        <Link href="/auditorio/dias/29-10/priscila-charbonneres">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/dr-paul-drouin">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/gregg-braden">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/luiz-augusto-de-queiroz">
                            <a>
                        ...
                        <Link href="/auditorio/dias/29-10/projeto-noosphere">
                            <a>
                    ...
                    <img src="/images/auditorios/29-10/auditorio.jpg" className="img-background" />
                </div>
            }
        </>
    )
