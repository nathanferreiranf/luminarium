...
export default function Live() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Auditório - Live</title>
            </Head>
            {
                authenticated && <div id="page-video">
                    <div className="video">
                        <iframe src="https://vimeo.com/event/409573/embed/4434aee1da" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
                    <div className="chat">
