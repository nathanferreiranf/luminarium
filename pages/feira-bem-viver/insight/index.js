...
export default function Insight() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Feira bem viver - Insight</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1062" preserveAspectRatio="none">
                        <Link href="/feira-bem-viver/insight/video">
                            <a>
                        ...
                        <a href="https://www.instagram.com/insighttimerbr/" target="_blank">
                            <polygon className="polygon" points="1226.38,428.28 1214.89,434.91 1208.51,447.94 1208.51,460.7 1212.09,467.6 1220,475 1230.21,479.6 
                                1238.38,479.6 1248.09,477.04 1255.49,469.89 1261.36,458.4 1261.36,449.72 1254.47,438.23 1245.02,430.57 1236.09,428.28 "/>
                        </a>
                        <a href="https://insig.ht/luminarium" target="_blank">
                            <polygon className="polygon" points="1294.81,422.66 1296.34,479.6 1350.72,477.04 1348.43,420.62 "/>
                        </a>
                        <a href="https://apptuts.bio/insighttimerbr" target="_blank">
                    ...
                    <img src="/images/_09.png" className="img-background" />
