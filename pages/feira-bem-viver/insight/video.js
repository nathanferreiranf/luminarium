...
export default function InsightVideo() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Video - Insight</title>
            </Head>
            {
                authenticated && <div id="page-only-video">
                    <div className="video shadow-sm">
                        <iframe src="https://drive.google.com/file/d/1JwECK9zbl1rQYys8ffuYKmVDnQ1ajLwM/preview" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
