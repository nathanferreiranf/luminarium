...
export default function FloraisSaintGermainVideo() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Video - Fórmulas compostas prontas</title>
            </Head>
            {
                authenticated && <div id="page-only-video">
                    <div className="video shadow-sm">
                        <iframe src="https://www.youtube.com/embed/Vxcd2EoiVHI" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
