...
export default function ApresentacaoVideo() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Video - Apresentação</title>
            </Head>
            {
                authenticated && <div id="page-only-video">
                    <div className="video shadow-sm">
                        <iframe src="https://www.youtube.com/embed/Zcuh8vo8lzQ" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
