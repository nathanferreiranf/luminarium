...
export default function BrahmaKumaris() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Feira bem viver - Brahma Kumaris</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1062" preserveAspectRatio="none">

                        <Link href='/feira-bem-viver/brahma-kumaris/brahma-kumaris-video'>
                            <a>
                        ...
                        <a href="https://www.facebook.com/editorabrahmakumaris/" target="_blank">
                            <polygon className="polygon" points="1050.72,385.13 1050.72,423.17 1086.21,421.89 1086.21,381.81 "/>
                        </a>
                        <a href="https://www.instagram.com/editorabrahmakumaris/" target="_blank">
                            <polygon className="polygon" points="1088,421.13 1088,384.36 1122.72,381.81 1122.72,419.09 "/>
                        </a>


                        <a href="http://www.editorabk.org.br/" target="_blank">
                    ...
                    <img src="/images/_07.png" className="img-background" />
