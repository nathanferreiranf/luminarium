...
export default function TerapeuticasCorporal() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Terapêuticas - Corporal</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/corporal/arteterapia">
                            <a>
                        ...
                        <Link href="/terapeuticas/corporal/fisio-sistemica">
                            <a>
                        ...
                        <Link href="/terapeuticas/corporal/corpo-terapia">
                            <a>
                        ...
                        <Link href="/terapeuticas/corporal/yoga">
                            <a>
                    ...
                    <img src="/images/corporal.jpg" className="img-background" />
                </div>
            }
        </>
    )
