...
export default function TerapeuticasTecnologias() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Terapêuticas - Tecnologia</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/tecnologias/biomagnetismo">
                            <a>
                        ...
                        <Link href="/terapeuticas/tecnologias/quantec">
                            <a>
                        ...
                        <Link href="/terapeuticas/tecnologias/plasma-e-orgonica">
                            <a>
                        ...
                        <Link href="/terapeuticas/tecnologias/sintonia-quantica">
                            <a>
                    ...
                    <img src="/images/tecnologia.jpg" className="img-background" />
                </div>
            }
        </>
    )
