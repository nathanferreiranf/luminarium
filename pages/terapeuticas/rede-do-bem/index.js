...
export default function RedeDoBem() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Terapêuticas - Rede do Bem</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/rede-do-bem/agricultura">
                            <a>
                        ...
                        <Link href="/terapeuticas/rede-do-bem/metodo-kovacsik">
                            <a>
                        ...
                        <Link href="/terapeuticas/rede-do-bem/constelacao">
                            <a>
                        ...
                        <Link href="/terapeuticas/rede-do-bem/word-heal">
                            <a>
                    ...
                    <img src="/images/rede_do_bem.jpg" className="img-background" />
                </div>
            }
        </>
    )
