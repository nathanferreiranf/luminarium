...
export default function Sistemica() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Terapêuticas - Sistêmica</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/sistemica/astrologia">
                            <a>
                        ...
                        <Link href="/terapeuticas/sistemica/oncologia">
                            <a>
                        ...
                        <Link href="/terapeuticas/sistemica/desprogramacao">
                            <a>
                        ...
                        <Link href="/terapeuticas/sistemica/reolhar-pedagogico">
                            <a>
                    ...
                    <img src="/images/sistemica.jpg" className="img-background" />
                </div>
            }
        </>
    )
