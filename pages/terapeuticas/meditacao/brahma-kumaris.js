...
export default function BrahmaKumarisVideo() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Video - Brahma Kumaris</title>
            </Head>
            {
                authenticated && <div id="page-only-video">
                    <div className="video shadow-sm">
                        <iframe src="https://www.youtube.com/embed/wFhAaicTJXE" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                    </div>
