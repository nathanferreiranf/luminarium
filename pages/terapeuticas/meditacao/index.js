...
export default function Meditacao() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Meditação</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/meditacao/brahma-kumaris">
                            <a>
                        ...
                        <Link href="/terapeuticas/meditacao/insight-timer">
                            <a>
                        ...
                        <Link href="/terapeuticas/meditacao/escola-e-presidios">
                            <a>
                        ...
                        <Link href="/terapeuticas/meditacao/mindkids">
                            <a>
                    ...
                    <img src="/images/meditacao.jpg" className="img-background" />
                </div>
            }
        </>
    )
