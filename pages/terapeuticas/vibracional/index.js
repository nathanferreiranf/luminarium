...
export default function Vobracional() {
    ...
    return (
        <>
            <Head>
                <title>{process.env.APP_NAME} | Terapêuticas - Vibracional</title>
            </Head>
            {
                authenticated && <div className="page">
                    <svg viewBox="0 0 2000 1090" preserveAspectRatio="none">
                        <Link href="/terapeuticas/vibracional/terapia-ambiental">
                            <a>
                        ...
                        <Link href="/terapeuticas/vibracional/terapia-neutra">
                            <a>
                        ...
                        <Link href="/terapeuticas/vibracional/feng-shui-e-cristais">
                            <a>
                        ...
                        <Link href="/terapeuticas/vibracional/universo-florais">
                            <a>
                    ...
                    <img src="/images/vibracional.jpg" className="img-background" />
                </div>
            }
        </>
    )
